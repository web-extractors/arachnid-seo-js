...
const findElements = async (page, element) => await page.$$eval(element, elements => elements.length);
...
module.exports = { findImages, addImageStatusCode, findElements, divElements, htmlBody };